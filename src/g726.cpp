...
static const int qtab_726_24[3] = {8, 218, 331};

static const int qtab_726_32[7] = {-124, 80, 178, 246, 300, 349, 400};
 ...
 */
static void update(g726_state_t *s, int y, /* quantizer step size */
